...
export const BannerTop = () => {
  return (
    <div className='w-[1180px] h-[378px] absolute top-[1681px] left-[130px] rounded-[20px] bg-[#003459] z-0 overflow-hidden'>

<div className="relative w-[desired-width] h-[desired-height]">
...
<div className="w-[782.29px] h-[635px] absolute top-[-260px] left-[576.67px] gap-0 rounded-[99px]  opacity-100 -rotate-[-25.23deg] bg-[#FCEED5] z-10"></div>
</div>
...
<div>
    ...
    <h1 className='w-[535px] h-[68px] font-SVN-Gilroy top-[64px] absolute left-[692px] font-extrabold text-[52px] leading-[64px] mb-4 text-right z-30 text-[#003459] pr-[70px]'>
        One more friend
      </h1>
      <h2 className='w-[484px] h-[60px] top-[134px] absolute left-[741px] font-SVN-Gilroy font-bold text-[36px] leading-[54px] mb-4 text-right z-30 text-[#003459] pr-[70px]'>
        Thousands more fun!
      </h2>
      <p className='w-[425px] h-[54px] top-[196px] absolute left-[781px] font-SVN-Gilroy font-medium text-[12px] text-[#242B33] mb-6 text-right z-30 pr-[50px]'>
