...
export const Filter = () => {
  ...
  return (
    <div className='w-[480px] flex ml-[130px]'>
      ...
      <div className="mb-2 flex flex-col rounded border-b-[1px] border-gray-300 p-[10px] gap-[10px]">
      ...
      <div className="mb-2 rounded border-b-[1px] border-gray-300 p-[10px] gap-[10px]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <label className="flex gap-2">
            ...
            />
               <FaCircle size={15} className='mt-0.5 text-red-500'/>
          ...
          <label className="flex gap-2">
            ...
            />
                           <FaCircle size={15} className='mt-0.5 text-[#FBCEB1]'/>
          ...
          <label className="flex gap-2">
            ...
            />
                           <FaCircle size={15} className='mt-0.5 text-black'/>
          ...
          <label className="flex gap-2">
            ...
            />
                           <VscColorMode size={15} className='mt-0.5'/>
          ...
          <label className="flex gap-2">
            ...
            />
                           <FaCircle size={15} className='mt-0.5 text-[#C0C0C0]'/>
          ...
          <label className="flex gap-2">
            ...
            />
                           <FaCircle size={15} className='mt-0.5 text-[#CD7F32]'/>
